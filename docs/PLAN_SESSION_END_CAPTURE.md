...
**Sequencing:** v5.10.2 train (Secret-Gate Architecture) is drafted but not started.
SESSION_END_CAPTURE is independent of v5.10.2 — no file overlap. Can ship as v5.10.3
(patch) after v5.10.2 lands, or be carried as a parallel feature branch if v5.10.2 drags.
