...
When updating the R2/D2/D3 revisit-trigger or version-slot field in `docs/reference/decisions.md`, use the concrete version number, not `vX.Y.x`. Example: `v5.31.0` not `v5.31.x`.
...
- `docs/reference/decisions.md` — convention for how and when to update version slots in the decisions log.
