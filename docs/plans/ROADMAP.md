...
| [vacuum-container-side-build-2026-08-01](vacuum-container-side-build-2026-08-01.md) | vacuum (#0092) | **design locked, not started** | Runs the vacuum side-build in a one-shot backend container so container installs stop skipping vacuum. Depends on `converge-backend-db-mount-2026-08-01` — must land first. Preflight half of #0092 already shipped v5.170.0. |
