...
- [`PLAN_V5_10_1_ACTIVE_WORK_TIMER_REFRESH.md`](../PLAN_V5_10_1_ACTIVE_WORK_TIMER_REFRESH.md) — soft warning tier (`consider_refresh_active_work` at 12h) + optional yadgar systemd-user watchdog timer (6h cadence) for time-based refresh trigger. Closes recurring 22-23h tight-margin observation. 3 new env knobs. Patch on v5.10 train.
