...
- **migrations:** —
- **bc:** `BC-AC3a`, `BC-AC3b`
- **refs:** `yadgar/astrocyte_pool.py::AstrocytePool.consensus_retrieve`, `yadgar/server/tools/recall.py::_landscape_recall`
...
- **migrations:** —
- **bc:** `BC-C4`, `BC-VZ-R3`
- **refs:** `yadgar/sleep_compute/community.py::_CommunityMixin.detect_communities`, `yadgar/sleep_compute/community.py::_CommunityMixin.generate_cluster_summaries`, `yadgar/sleep_compute/__init__.py::SleepComputeEngine.run_sleep_cycle`, `yadgar/storage/cluster.py::_ClusterMixin.get_memory_clusters`, `yadgar/storage/cluster.py::_ClusterMixin.get_cluster_members`
...
- **migrations:** —
- **bc:** —
- **refs:** `yadgar/server/http.py::health_check`, `yadgar/server/http.py::_build_health_payload`, `yadgar/daemon.py`, `docker-compose.yml`
...
- **refs:** `yadgar/graph_api.py::GraphAPI`, `yadgar/server/http.py::api_graph`, `yadgar/server/http.py::api_graph_neighborhood`, `yadgar/server/http.py::api_graph_edges_lazy`, `yadgar/storage/cluster.py::_ClusterMixin.get_memory_clusters`, `yadgar/storage/cluster.py::_ClusterMixin.get_cluster_members`
