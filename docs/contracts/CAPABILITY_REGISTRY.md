...
- **migrations:** —
- **bc:** —
- **refs:** `yadgar/core/server/tools/agent_prompts.py::discipline_save`, `yadgar/_shared/wiki/prompt_guard.py::removed_prompt_lines`, `yadgar/core/server/tools/agent_prompts.py::_save_discipline_page`, `yadgar/_shared/wiki/store.py::_reject_if_discipline_weakening`
