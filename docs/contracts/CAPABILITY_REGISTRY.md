...
- **migrations:** —
- **bc:** —
- **refs:** `yadgar/core/server/tools/misc.py::install_hooks`, `yadgar/core/install/install_hooks_lib.py::install_hooks_impl`
