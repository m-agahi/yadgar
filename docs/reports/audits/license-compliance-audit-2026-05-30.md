...
(per `docs/reports/audits/competitor-audit-2026-05-30.md` and the 6 Adopt items) is license-compliant. Audit follows
...
**Required action:**
1. Document in `README.md` or `docs/reference/configuration.md` that yadgar requires a user-provided
...
5. **SurrealDB BSL disclosure in `README.md` / `docs/reference/configuration.md`:** Note that yadgar
