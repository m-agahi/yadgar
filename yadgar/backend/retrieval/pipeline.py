...
class RetrievalPipeline:
    ...
    def from_retriever(cls, retriever) -> RetrievalPipeline:
        ...
        """
        from yadgar.backend.retrieval.stages.adversarial import AdversarialStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.ce_rerank import CEReRankStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.fts import FTSStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.fusion import FusionStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.knn import KNNStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.mmr import MMRStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.nli import NLIStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.ppr import PPRStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.query_analysis import (
            QueryAnalysisStage,  # noqa: PLC0415
        )
        from yadgar.backend.retrieval.stages.rules import RulesStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.spreading import SpreadingStage  # noqa: PLC0415
        from yadgar.backend.retrieval.stages.temporal import TemporalStage  # noqa: PLC0415
