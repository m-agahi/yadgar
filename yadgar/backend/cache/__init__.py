...
_EXPORTS: Final = {
    ...
    "_make_config_ptc_cache": "yadgar.backend.cache.cache_budgets",
    "_make_ledger_ptc_cache": "yadgar.backend.cache.cache_budgets",
    ...
    "get_config_ptc_cache": "yadgar.backend.cache.cache_budgets",
    "get_engram_slot_cache": "yadgar.backend.cache.cache_budgets",
    "get_graph_cache": "yadgar.backend.cache.cache_budgets",
    "get_ledger_ptc_cache": "yadgar.backend.cache.cache_budgets",
