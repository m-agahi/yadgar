...
def _wiki_observe_stage(stage: str, elapsed_ms: float) -> None:
    ...
    try:
        from yadgar._shared.metrics import yadgar_wiki_query_stage_ms  # noqa: PLC0415
...
class WikiStore:
    ...
    def add(
        ...
        if existing:
            ...
            if page_type is not None:
                from yadgar._shared.wiki_meta import WIKI_SCHEMA_VERSION  # noqa: PLC0415
    ...
    def lint(self) -> dict:
        ...
        """
        from yadgar._shared.wiki_meta import check_page_type_format  # noqa: PLC0415
