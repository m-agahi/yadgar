...
from yadgar._shared.retrieval.entities import _QUERY_STOP_WORDS
from yadgar._shared.retrieval.query_analysis import _build_boosted_fts_query, _pseudo_hyde_expand
from yadgar._shared.retrieval.temporal import parse_temporal_expression
...
def _observe_stage(stage: str, elapsed_ms: float) -> None:
    ...
    try:
        from yadgar._shared.metrics import yadgar_recall_stage_ms  # noqa: PLC0415
