...
from yadgar._shared.protocols import CacheProtocol, MLClientProtocol, NullCache, NullMLClient

# Per-strategy mixin classes (sibling private modules)
from yadgar._shared.retrieval._reranking_confidence import _ConfidenceMixin
...
from yadgar._shared.retrieval._reranking_nli import _NLIMixin
