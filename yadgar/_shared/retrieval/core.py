...
from yadgar._shared.retrieval.fusion import PROFILES, _FusionMixin
from yadgar._shared.retrieval.graph_helpers import _GraphHelpersMixin
from yadgar._shared.retrieval.quality import _QualityMixin
from yadgar._shared.retrieval.query_analysis import (
    _build_open_domain_subqueries,
    analyze_query,
)
from yadgar._shared.retrieval.reranking import RerankContext, Reranker, _RerankingMixin
from yadgar._shared.retrieval.scoring import FTSParams, _ScoringMixin
...
class Retriever(_ScoringMixin, _FusionMixin, _RerankingMixin, _GraphHelpersMixin, _QualityMixin):
    ...
    def _get_pipeline(self):
        ...
        if self._pipeline is None:
            from yadgar._shared.retrieval.pipeline import RetrievalPipeline  # noqa: PLC0415
    ...
    def recall_via_pipeline(
        ...
        from yadgar._shared.retrieval.state import RetrievalState  # noqa: PLC0415
