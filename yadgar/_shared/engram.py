"""Back-compat shim — engram moved into ``yadgar._shared.contracts`` (T2 Car D1, no-lone-files law ADR-0084).
...
access. New code must import from ``yadgar._shared.contracts.engram`` instead.
"""

from typing import Final

_TARGET: Final = "yadgar._shared.contracts.engram"
_EXPORTS: Final = (
    "EngramAllocator",
    "Settings",
    "StorageEngine",
