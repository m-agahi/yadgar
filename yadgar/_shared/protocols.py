"""Back-compat shim — protocols moved into ``yadgar._shared.contracts`` (T2 Car D1, no-lone-files law ADR-0084).
...
access. New code must import from ``yadgar._shared.contracts.protocols`` instead.
"""

from typing import Final

_TARGET: Final = "yadgar._shared.contracts.protocols"
_EXPORTS: Final = (
    "Any",
    "CacheProtocol",
    "Hashable",
