...
async def api_wiki_history(request: Request) -> JSONResponse:
    ...
    try:
        from yadgar.server.tools.wiki import wiki_history  # noqa: PLC0415
...
async def api_wiki_read_version(request: Request) -> JSONResponse:
    ...
    try:
        from yadgar.server.tools.wiki import wiki_read_version  # noqa: PLC0415
...
async def api_wiki_diff(request: Request) -> JSONResponse:
    ...
    try:
        from yadgar.server.tools.wiki import wiki_diff  # noqa: PLC0415
...
async def api_wiki_restore(request: Request) -> JSONResponse:
    ...
    try:
        from yadgar.server.tools.wiki import wiki_restore  # noqa: PLC0415
