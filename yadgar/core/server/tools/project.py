...
def project_brief(directory: str, mode: str = "catalog", *, project: str | None = None) -> dict:
    ...
    # Car F9: the validated override is KEPT, not discarded. ``signals`` mode
    # forwards it to the session-end sentinel check, whose rows C10 (f) keys on
    # the resolved project_id. Dropping the return value here was half of why
    # the feature was dead: the reader held an identity and threw it away.
