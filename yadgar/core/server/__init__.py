...
from yadgar.core.server._app import (  # noqa: F401
    mcp_server,
    _tool,
    _PROFILE,
...
import yadgar._shared.runtime.state as _state_mod  # noqa: F401

from yadgar._shared.runtime.state import (  # noqa: F401
    _queue_lock,
    _event_lock,
    _metrics_lock,
    _action_batch_lock,
...
from yadgar._shared.runtime.lifecycle import (  # noqa: F401
    _get_storage,
    _get_embeddings,
    _get_buffer,
    _get_consolidation,
...
# which are _shared→server edges that must not live in _shared).
from yadgar.core.server._startup import main  # noqa: F401

# ── 5. HTTP routes (side-effects: registers @mcp_server.custom_route) ─
import yadgar.core.server.http  # noqa: F401
import yadgar.core.server.admin_config  # noqa: F401 — v5.6.7 PR-J: GET /admin/config route
import yadgar.core.server.http_bookmarks  # noqa: F401 — v5.23.0: bookmark + wiki routes
import yadgar.core.server.http_wiki_versioning  # noqa: F401 — v5.50.1: wiki query/history/diff/restore
import yadgar.core.server.routes.control_update  # noqa: F401 — v5.48.0: POST /api/control/update
import yadgar.core.server.routes.control  # noqa: F401 — v5.50.2: GET+POST /api/control/config, POST /api/control/action/*, POST /api/control/restart/*
import yadgar.core.server.routes.logs  # noqa: F401 — v5.52.0: GET /api/logs/_capabilities, /api/logs/poll, /api/logs/stream
...
from yadgar.core.server.http import (  # noqa: F401
    health_check,
    metrics_endpoint,
    hook_pre_compact,
    hook_post_compact,
...
from yadgar.core.server.tools import (  # noqa: F401
    memorize,
    recall,
    project_brief,
    bootstrap_project,
