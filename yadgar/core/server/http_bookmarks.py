...
async def api_bookmarks_list(request: Request) -> JSONResponse:
    ...
    """
    from yadgar.core.server.tools.bookmarks import bookmark_list  # noqa: PLC0415
...
async def api_bookmarks_add(request: Request) -> JSONResponse:
    ...
    """
    from yadgar.core.server.tools.bookmarks import bookmark_add  # noqa: PLC0415
...
async def api_bookmarks_remove(request: Request) -> JSONResponse:
    ...
    """
    from yadgar.core.server.tools.bookmarks import bookmark_remove  # noqa: PLC0415
...
async def api_bookmarks_reorder(request: Request) -> JSONResponse:
    ...
    """
    from yadgar.core.server.tools.bookmarks import bookmark_reorder  # noqa: PLC0415
