"""Back-compat shim — sd_notify moved into ``yadgar.core.daemon`` (T2 Car D3, no-lone-files law ADR-0084).
...
access. New code must import from ``yadgar.core.daemon.sd_notify`` instead.
"""

from typing import Final

_TARGET: Final = "yadgar.core.daemon.sd_notify"
_EXPORTS: Final = (
    "annotations",
    "logger",
    "logging",
