...
def _cmd_check(args: argparse.Namespace) -> None:  # noqa: ARG001
    ...
    from yadgar.core.update import install_methods  # noqa: PLC0415
...
def _install_exit(result: object) -> None:  # type: ignore[override]
    ...
    from yadgar.core.update.orchestrator import OrchestratorResult  # noqa: PLC0415
...
def _install_msg_code(result: object) -> tuple[str, int]:  # noqa: PLR0911
    ...
    from yadgar.core.update.orchestrator import (  # noqa: PLC0415
        OrchestratorResult,
        OrchestratorState,
    )
...
def _cmd_install(args: argparse.Namespace) -> None:
    """Run the routine-upgrade orchestrator."""
    from yadgar.core.update.orchestrator import InstallConfig, run_install  # noqa: PLC0415
...
def _cmd_rollback(args: argparse.Namespace) -> None:
    ...
    from yadgar.core.update.snapshot import latest_snapshot  # noqa: PLC0415
    ...
    if args.snapshot:
        ...
        from yadgar.core.update.snapshot import Snapshot  # noqa: PLC0415
