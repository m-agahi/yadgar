...
T2 Car A (layer-boundary train): moved from yadgar/_shared/platform_paths.py —
core-only importers (dual-import law), install-adjacent home. A PEP-562
back-compat shim remains at the old path.
"""
