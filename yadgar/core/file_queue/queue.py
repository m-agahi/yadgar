...
class FileQueue:
    ...
    @observe(tier="hot", metric="queue.register_wait")
    ...
    @observe(tier="hot", metric="queue.signal_complete_with_result")
    ...
    @observe(tier="hot", metric="queue.get_job_result")
    ...
    @observe(tier="hot", metric="queue.cleanup_job")
