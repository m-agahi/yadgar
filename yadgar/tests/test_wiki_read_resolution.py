...
def _engines(tmp_path_factory):
    tmp_path = tmp_path_factory.mktemp("wiki_read_resolution")
...
class TestWikiReadResolutionOrder:
    ...
    def test_returns_current_branch_page_when_exists(self, monkeypatch):
        ...
        monkeypatch.setattr("yadgar.core.server._detect_branch", lambda _d: "feat/wiki-res")
    ...
    def test_falls_back_to_default_branch_when_no_current(self, monkeypatch):
        ...
        monkeypatch.setattr("yadgar.core.server._detect_branch", lambda _d: "feat/absent-branch")
        monkeypatch.setattr("yadgar.core.server._get_default_branch", lambda _d: "master")
        storage = server._wiki._storage
    ...
    def test_falls_back_to_none_branch_when_no_current_or_default(self, monkeypatch):
        ...
        monkeypatch.setattr("yadgar.core.server._detect_branch", lambda _d: "feat/absent")
        monkeypatch.setattr("yadgar.core.server._get_default_branch", lambda _d: "main")
        storage = server._wiki._storage
    ...
    def test_returns_error_when_slug_not_found(self, monkeypatch):
        ...
        monkeypatch.setattr("yadgar.core.server._detect_branch", lambda _d: "feat/any")
        monkeypatch.setattr("yadgar.core.server._get_default_branch", lambda _d: "master")
    ...
    def test_current_branch_page_preferred_over_none_branch(self, monkeypatch):
        ...
        monkeypatch.setattr("yadgar.core.server._detect_branch", lambda _d: "feat/preferred")
        monkeypatch.setattr("yadgar.core.server._get_default_branch", lambda _d: "master")
        storage = server._wiki._storage
