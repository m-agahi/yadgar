...
def test_encode_duration_histogram_increments():
    ...
    from yadgar._shared.observability.metrics import yadgar_encode_duration_ms
...
def test_entity_extract_duration_histogram_increments():
    ...
    from yadgar._shared.observability.metrics import yadgar_entity_extract_duration_ms
...
def test_subagent_dispatch_count_increments():
    ...
    from yadgar._shared.observability.metrics import yadgar_subagent_dispatch_count
...
def test_sse_clients_gauge_inc_dec():
    ...
    from yadgar._shared.observability.metrics import yadgar_viz_sse_clients
...
def test_viz_api_graph_duration_increments():
    ...
    from yadgar._shared.observability.metrics import yadgar_viz_api_graph_duration_ms
    from yadgar.core.server import http as http_mod
    ...
    # T2 Car E3: the handler forwards to the backend /viz route — patch the
...
def test_log_file_rotations_counter_increments(tmp_path):
    ...
    from yadgar._shared.observability.metrics import yadgar_log_file_rotations_total
...
def test_log_dropped_counter_increments():
    ...
    from yadgar._shared.observability.metrics import yadgar_log_dropped_total
