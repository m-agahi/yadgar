...
class TestMemoryAddedSseType:
    ...
    def _call_build_response(self, captured: list) -> None:
        from yadgar.backend.write_exec._memorize_phases import _phase_post_write as pw
...
class TestSseNodeTypePresentInSource:
    ...
    def test_wiki_source_has_type_wiki_at_both_emit_sites(self) -> None:
        ...
        # R3 Car 1: the wiki_add write path (incl. its SSE emit sites) moved
        # from core.server.tools.wiki to the backend write executor.
        import yadgar.backend.write_exec.wiki_add_impl as wiki_mod
        ...
        assert count >= 2, (
            f"Expected at least 2 occurrences of 'type': 'wiki' in wiki_add_impl.py "
