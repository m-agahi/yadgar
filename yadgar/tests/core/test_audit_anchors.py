...
# R3 Car 3d: audit_anchors' apply/write half forwards to the backend /admin op.
# Route those forwards through run_admin_op against the same _st storage the
# fixtures populate (no HTTP), so the dry_run=False mutation assertions stay real.
