...
def _memory_py() -> Path:
    root = Path(__file__).parent.parent.parent  # yadgar/ package root
...
class TestDecayScalarProjection:
    ...
    def test_heat_decay_calls_scalar_method(self):
        ...
        # R3 Car 1: consolidation compute (incl. heat_decay) moved core → backend.
        decay_py = root / "backend" / "consolidation" / "heat_decay.py"
