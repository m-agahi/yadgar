...
class TestRecallToolWiring:
    ...
    def test_memorize_bumps_epoch_via_phase(self):
        ...
        from yadgar.backend.write_exec._memorize_phases._phase_post_write import _bump_shadow_epoch
    ...
    def test_consolidation_bumps_global_epoch(self):
        ...
        from yadgar._shared.runtime.cache_epoch import _current_epoch
        from yadgar.backend.consolidation.cls import _bump_shadow_epoch_global
