...
from yadgar.install_hooks_lib import (
    _append_if_absent,
    _build_core_hooks,
    _load_settings,
    _make_hook_entry,
...
def test_copy_hook_dry_run_does_nothing(tmp_path):
    from yadgar.install_hooks_lib import _copy_hook
...
def test_atomic_write_creates_file(tmp_path):
    from yadgar.install_hooks_lib import _atomic_write
...
def test_write_global_stop_hooks_creates_settings(tmp_path):
    from yadgar.install_hooks_lib import _write_global_stop_hooks
...
def test_copy_scope_scripts_dry_run_no_files(tmp_path):
    from yadgar.install_hooks_lib import _copy_scope_scripts
