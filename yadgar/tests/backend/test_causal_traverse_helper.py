...
from yadgar.backend.causal_discovery import CausalDiscovery as CausalDiscoveryEngine
...
def test_helper_is_importable():
    from yadgar.backend.causal_discovery import _traverse_oriented_edges  # noqa: F401
