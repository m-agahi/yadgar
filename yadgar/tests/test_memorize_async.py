...
def test_write_gate_skipped_when_threshold_zero():
    ...
    assert gate is not None, "WriteGate should be initialized by _engines fixture"
    ...
    try:
        with patch.object(
            gate, "compute_surprisal", wraps=gate.compute_surprisal
        ) as mock_surprisal:
        ...
        gate._settings.WRITE_GATE_THRESHOLD = original_threshold
