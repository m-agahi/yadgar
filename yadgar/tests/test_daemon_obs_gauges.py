...
def _reset_loop_lag_max():
    ...
    """
    from yadgar.metrics import yadgar_event_loop_lag_max_seconds
...
def test_loop_lag_monitor_cancels_cleanly():
    ...
    from yadgar.metrics import start_loop_lag_monitor, stop_loop_lag_monitor
...
def test_pool_gauges_reflect_offload_state(monkeypatch):
    ...
    import yadgar.server._offload as offload
    from yadgar.metrics import (
        _collect_pool_stats,
...
def test_pool_gauge_saturated_flag(monkeypatch):
    ...
    import yadgar.server._offload as offload
    from yadgar.metrics import _collect_pool_stats, yadgar_tool_pool_saturated
